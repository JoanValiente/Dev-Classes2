...
j1App::j1App(int argc, char* args[]) : argc(argc), args(args)
{
	...
	int ConstructorTime = timer.ReadMs();
	LOG("Time Constructor App:%i", ConstructorTime);
}
...
bool j1App::Awake()
{
	...
	int AwakerTime = timer.ReadMs();
	LOG("Time Awake App:%i", AwakerTime);
...
bool j1App::Start()
{
	...
	int StarTime = timer.ReadMs();
	LOG("Time Star App:%i", StarTime);
	return ret;
}
